...
from .echarts_converter import records_to_graph, normalize_records
...
async def nlq(payload: NLQRequest) -> NLQResponse:
    ...
    try:
        ...
        return NLQResponse(
            cql=cql,
            params=params or {},
            graph=GraphPayload(nodes=nodes, links=links, meta={"nodeCount": len(nodes), "linkCount": len(links), "categories": categories_payload}),
